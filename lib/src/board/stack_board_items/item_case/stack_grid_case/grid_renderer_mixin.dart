...
import 'package:idev_v1/src/board/stack_board_items/common/new_field.dart'; // For FieldType
...
mixin GridRendererMixin on State<StackGridCase> {
  ...
  Widget imageUrlRenderer(TrinaColumnRendererContext c) {
    ...
    Uri? parsedUri = Uri.tryParse(initialValue);
    Uri finalUri;
    ...
    if (parsedUri != null && parsedUri.hasScheme && parsedUri.hasAuthority) {
      ...
      finalUri = baseUri.resolve(initialValue);
    }
