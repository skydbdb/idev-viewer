...
abstract class ILayoutState {
  ...
  void setShowFooter(bool flag, {bool notify = true});
...
mixin LayoutState implements ITrinaGridState {
  ...
  @override
  bool get showFooter => createFooter != null && (_state._showFooter ?? true);
  ...
  @override
  void setShowFooter(bool flag, {bool notify = true}) {
    if (_state._showFooter == flag) {
      return;
    }

    _state._showFooter = flag;

    notifyListeners(notify, setShowFooter.hashCode);
  }
