...
class TrinaGridConfiguration {
  ...
  /// 그룹 헤더 탭 이벤트 콜백
  final void Function(TrinaColumnGroup group)? onGroupHeaderTap;

  /// 그룹 헤더 드래그 시작 이벤트 콜백
  final void Function(TrinaColumnGroup group)? onGroupHeaderDragStart;

  /// 그룹 헤더 드래그 업데이트 이벤트 콜백
  final void Function(TrinaColumnGroup group)? onGroupHeaderDragUpdate;

  /// 그룹 헤더 드래그 종료 이벤트 콜백
  final void Function()? onGroupHeaderDragEnd;

  /// 그룹 헤더 스타일 콜백
  final TextStyle? Function(TrinaColumnGroup group)? groupHeaderStyle;
  ...
  const TrinaGridConfiguration({
    ...
    this.onGroupHeaderDragStart,
    this.onGroupHeaderDragUpdate,
    this.onGroupHeaderDragEnd,
  ...
  TrinaGridConfiguration copyWith({
    ...
    void Function(TrinaColumnGroup group)? onGroupHeaderTap,
    void Function(TrinaColumnGroup group)? onGroupHeaderDragStart,
    void Function(TrinaColumnGroup group)? onGroupHeaderDragUpdate,
    void Function()? onGroupHeaderDragEnd,
    TextStyle? Function(TrinaColumnGroup group)? groupHeaderStyle,
  }) {
    return TrinaGridConfiguration(
      ...
      onGroupHeaderTap: onGroupHeaderTap ?? this.onGroupHeaderTap,
      onGroupHeaderDragStart:
          onGroupHeaderDragStart ?? this.onGroupHeaderDragStart,
      onGroupHeaderDragUpdate:
          onGroupHeaderDragUpdate ?? this.onGroupHeaderDragUpdate,
      onGroupHeaderDragEnd: onGroupHeaderDragEnd ?? this.onGroupHeaderDragEnd,
  ...
  bool operator ==(covariant Object other) {
    return identical(this, other) ||
        other is TrinaGridConfiguration &&
            ...
            onGroupHeaderTap == other.onGroupHeaderTap &&
            onGroupHeaderDragStart == other.onGroupHeaderDragStart &&
            onGroupHeaderDragUpdate == other.onGroupHeaderDragUpdate &&
            onGroupHeaderDragEnd == other.onGroupHeaderDragEnd &&
            groupHeaderStyle == other.groupHeaderStyle;
  }
...
class TrinaGridStyleConfig {
  const TrinaGridStyleConfig({
    ...
    this.columnHeight = 30, //TrinaGridSettings.rowHeight,
