...
import 'package:idev_viewer/src/internal/const/const.dart';
import '../../../grid/trina_grid/trina_grid.dart';
import 'package:idev_viewer/src/internal/layout/helper/info_dialog.dart'; // 경로 수정 (가정)
...
class _PopupGridState extends State<PopupGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    // 테마에 따른 다크모드 설정
    final isDarkMode = widget.configuration?.style.gridBackgroundColor ==
