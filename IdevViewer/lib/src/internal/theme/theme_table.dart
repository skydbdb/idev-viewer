...
final Map<Color, Map<String, dynamic>> themeTableStyles = {
  // white 테마 (밝은 배경, 어두운 텍스트)
  Colors.white: {
    'backgroundColor': Colors.white,
    'borderColor': Colors.grey[300]!,
    'labelBackgroundColor': Colors.grey[50]!,
...
dynamic tableStyle(String theme, String key) {
  final Color color = themes[theme]!;
  return themeTableStyles[color]?[key];
}
